...
/// <summary>
///     This trap works, but is very visually noisy. There may be a value somewhere that can be controlled to slow it down,
...
public class CanvasScrollTrap : ITrap {
    ...
    private NoteConfigData CreateUpScrollNoteData() {
    ...
    private NoteConfigData CreateDownScrollNoteData() {
        return new NoteConfigData() {
            id = "67",
            ibms_id = "28",
            uid = "000801",
