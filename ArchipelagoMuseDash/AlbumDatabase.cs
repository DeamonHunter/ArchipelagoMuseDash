...
namespace ArchipelagoMuseDash
{
    ...
    {
        private Dictionary<string, MusicInfo> _songsByItemName = new Dictionary<string, MusicInfo>();
        private Dictionary<string, List<MusicInfo>> _songsByAlbum = new Dictionary<string, List<MusicInfo>>();

        private Dictionary<string, MusicInfo> _songsByUid = new Dictionary<string, MusicInfo>();
        private readonly Dictionary<long, string> _songIDToUid = new Dictionary<long, string>();
        private readonly Dictionary<long, string> _albumIDToAlbumString = new Dictionary<long, string>(); //Not Used yet
        ...
        private static readonly Dictionary<string, string> _currentNamesToOldNames = new Dictionary<string, string>()
        {
