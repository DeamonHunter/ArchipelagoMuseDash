...
public class ArchipelagoRecords {
    ...
    private string RecordPath() {
        return Path.Combine(Application.absoluteURL, "UserData", "ArchipelagoRecords.json");
    }
    ...
    public void RecordHighScore(string activeTrap) {
        ...
        var newRecord = new Record {
            Score = score,
            Accuracy = taskStage.GetAccuracy(),
            Character = GlobalDataBase.dbBattleStage.selectedRole,
            Elfin = GlobalDataBase.dbBattleStage.selectedElfin,
            Trap = activeTrap ?? "",
            Combo = taskStage.GetComboMax(),
            IsFullCombo = taskStage.IsFullCombo()
        };
